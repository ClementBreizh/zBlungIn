...
public class AdressDaoUpdateTest {
     ...
     *
     * @throws SQLException
     * Before each test, drop & create the table and add / insert new addresses
     */
    @Before
    ...
    public void simpleUpdateCompareAddress1() throws SQLException {
        ...
        assertTrue(dbAddress.getId() == dbAddressUpdated.getId() && !dbAddress.getAddress().equals(dbAddressUpdated.getAddress())
    ...
    public void simpleUpdateCompareAddress2() throws SQLException {
        ...
        assertTrue(address.getId() == dbAddressUpdated.getId() && address.getAddress().equals(dbAddressUpdated.getAddress()));
    }
   ...
   public void simpleUpdateComparePostalCode1() throws SQLException {
       ...
       assertTrue(dbAddress.getId() == dbAddressUpdated.getId() && !dbAddress.getPostalCode().equals(dbAddressUpdated.getPostalCode())
   ...
   public void simpleUpdateComparePostalCode2() throws SQLException {
       ...
       assertTrue(address.getId() == dbAddressUpdated.getId() && address.getPostalCode().equals(dbAddressUpdated.getPostalCode()));
   }
