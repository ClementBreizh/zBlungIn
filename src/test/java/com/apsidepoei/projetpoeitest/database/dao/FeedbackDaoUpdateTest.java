...
//
//    assertTrue(dbFeedback.getId() == dbFeedbackUpdated.getId()
//        && !dbFeedback.getTypeOfContract().equals(dbFeedbackUpdated.getTypeOfContract())
...
//        && feedback.getTypeOfContract().equals(dbFeedbackUpdated.getTypeOfContract()));
//  }
//
//  /**
...
//
//    assertTrue(dbFeedback.getId() == dbFeedbackUpdated.getId()
//        && !dbFeedback.getDurationOfContract().equals(dbFeedbackUpdated.getDurationOfContract())
...
//
//    assertTrue(feedback.getId() == dbFeedbackUpdated.getId()
//        && feedback.getDurationOfContract().equals(dbFeedbackUpdated.getDurationOfContract()));
//  }
//
//  /**
//   * Compare the modification with the update
...
//
//    assertTrue(feedback.getId() == dbFeedback.getId()
//        && feedback.getDurationOfContract().equals(dbFeedback.getDurationOfContract()));
//  }
//
//  // Simple compare town
//  /**
...
//
//    assertTrue(dbFeedback.getId() == dbFeedbackUpdated.getId()
//        && !dbFeedback.getComment().equals(dbFeedbackUpdated.getComment())
