...
//}
	...
	public void simpleUpdateCompareCategory1() throws SQLException {
		...
		assertTrue(dbAssessment.getId() == dbAssessmentUpdated.getId() && !dbAssessment.getCategory().equals(dbAssessmentUpdated.getCategory())
	...
	public void simpleUpdateCompareDate1() throws SQLException, ParseException {
		...
		assertFalse(dbAssessment.getId() == dbAssessmentUpdated.getId() && !dbAssessment.getDateTime().equals(dbAssessmentUpdated.getDateTime())
	...
	public void simpleUpdateCompareDate2() throws SQLException, ParseException {
		...
		assertFalse(assessment.getId() == dbAssessmentUpdated.getId() && assessment.getDateTime().equals(dbAssessmentUpdated.getDateTime()));
	}
	...
	public void simpleUpdateCompareDate3() {
		...
		assertFalse(assessment.getId() == dbAssessment.getId() && assessment.getDateTime().equals(dbAssessment.getDateTime()));
	}
