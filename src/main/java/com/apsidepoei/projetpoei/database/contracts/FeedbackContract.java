...
public class FeedbackContract extends BaseContract {
    ...
    public final static String[] COLS = new String[] {
            COL_ID,
            COL_TYPE_OF_CONTRACT,
            COL_DURATION_OF_CONTRACT,
            COL_COMMENT,
    };

    public final static String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS "+ TABLE +"(" +
            COL_ID + " int NOT NULL AUTO_INCREMENT PRIMARY KEY," +
            COL_TYPE_OF_CONTRACT + " VARCHAR(50) NOT NULL," +
            COL_DURATION_OF_CONTRACT + " TINYINT NOT NULL," +
            COL_COMMENT + " VARCHAR(255) NOT NULL" +
            ")";
