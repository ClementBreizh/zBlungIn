...
//      System.out.println(candidate);
    ...
    // Company Validate
//    for (int i = 0; i < nbEntities; i++) {
//      CompanyValidatedCandidatesSession cvcs = new CompanyValidatedCandidatesSession();
//      cvcs.setCompany(companyRepository.findById(1).get());
//      cvcs.setSession(sessionRepository.findById(1).get());
//      cvcs.getValidatedCandidates().add(candidateRepository.findById(11).get());
//      companyValidatedCandidatesSessionRepository.save(cvcs);
//    }
